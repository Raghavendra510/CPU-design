...
void insdecode(mowb &obj5, exmo &obj4, ifid &obj2, idex &obj3, immgen &gen, controlPath &cp, regFile &rf)
{
    if (obj2.v == 0)
    {
        return;
    ...
    if (obj4.v == 1 && obj4.rdl == rsl1 && obj4.op == 1)
    {

        obj2.s = 1;
        return;
    }
    if (obj4.v == 1 && obj4.rdl == rsl2 && obj4.op == 1)
    {

        obj2.s = 1;
        return;
    }
    if (obj5.v == 1 && obj5.rdl == rsl1 && obj5.op == 1)
    {
        obj3.rs1 = obj5.ldout;
        return;
    }

    if (obj5.v == 1 && obj5.rdl == rsl2 && obj5.op == 1)
    {
        obj3.rs2 = obj5.ldout;
        return;
    }
...
void execute(ipc &obj1, ifid &obj2, idex &obj3, exmo &obj4, ALU &alu, ALUcontrol &ac, mowb &obj5, regFile &rf)
{
    if (obj3.v == 0)
    {
        return;
    }
    obj4.alusrc = obj3.alusrc;
    int alusrc = obj3.alusrc;

    obj4.rs2 = obj3.rs2;
    int alus1, alus2;
    if (obj5.v == 1 && (obj5.rdl == obj3.rsl1) && obj5.op == 1)
    {
        alus1 = obj5.ldout;
    }
    else if (obj5.v == 1 && obj5.rdl == obj3.rsl1)
    {
        alus1 = obj5.aluout;
    }
    else
    ...
    if (obj5.v == 1 && (obj5.rdl == obj3.rsl2) && obj5.op == 1)
    {
        alus2 = obj5.ldout;
    }
    else if (obj5.v == 1 && obj5.rdl == obj3.rsl2 && (obj5.branch || obj5.alusrc == 0))
    {
        alus2 = obj5.aluout;
    }
    else
    ...
    alu.compute(alus1, alus2, ac.aluselect);
...
int main()
{
    ...
    while (1)
    {
        ...
        execute(obj1, obj2, obj3, obj4, alu, ALUControl, obj5, RegFile);

        insdecode(obj5, obj4, obj2, obj3, ImmGen, ControlPath, RegFile);

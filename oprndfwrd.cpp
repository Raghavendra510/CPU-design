...
void insdecode(exmo &obj4, mowb &obj5, ifid &obj2, idex &obj3, immgen &gen, controlPath &cp, regFile &rf)
{
    ...
    if (obj4.v && obj4.memread && obj4.rdl != 0 && (obj4.rdl == rsl1 || obj4.rdl == rsl2))
    {
        obj2.s = 1;
        return;
    }
    if (obj5.v && obj5.regwrite && obj5.rdl != 0 && (obj5.rdl == rsl1 || obj5.rdl == rsl2))
    {
        obj2.s = 1;
        return;
    }
...
void execute(mowb &obj5, ipc &obj1, ifid &obj2, idex &obj3, exmo &obj4, ALU &alu, ALUcontrol &ac)
{
    if (obj4.s || (!obj3.v))
        return;
    ...
    int alu_in1 = obj3.rs1;
    int alu_in2_reg = obj3.rs2;

    if (obj5.v && obj5.regwrite && obj5.rdl != 0 && obj5.rdl == obj3.rsl1)
    {
        alu_in1 = (obj5.memread) ? obj5.ldout : obj5.aluout;
    }

    if (obj5.v && obj5.regwrite && obj5.rdl != 0 && obj5.rdl == obj3.rsl2)
    {
        alu_in2_reg = (obj5.memread) ? obj5.ldout : obj5.aluout;
    }
    int alusrc2;
    obj4.rs2 = alu_in2_reg;
    if (alusrc == 1)
    {
        alusrc2 = obj3.imm2;
    }
    ...
    alu.compute(alu_in1, alusrc2, ac.aluselect);
...
int main()
{
    ...
    while (1)
    {
        ...
        execute(obj5, obj1, obj2, obj3, obj4, alu, ALUControl);
        insdecode(obj4, obj5, obj2, obj3, ImmGen, ControlPath, RegFile);
